-- Migration: Update Rental Permissions Descriptions
-- Created: 2025-11-13
-- Description: Cập nhật mô tả permissions cho thuê ngắn gọn hơn, phù hợp với format của các permissions khác
