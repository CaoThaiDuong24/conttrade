...
export const sellNewTourSteps: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Chọn loại giao dịch: Bán (SALE) hoặc Thuê (RENTAL). Loại giao dịch sẽ ảnh hưởng đến thông tin giá cả.',
      side: 'bottom',
      align: 'start',
    },
  },
  ...
  // ============ 🆕 RENTAL MANAGEMENT TOUR STEPS (chỉ hiển thị khi chọn RENTAL) ============
