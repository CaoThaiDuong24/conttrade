        ...
        if (response.ok) {
          ...
          const mappedListings = (data.data?.listings || []).map((listing: any) => {
            ...
            return {
              ...
              // Quantity fields
              totalQuantity: listing.total_quantity || 0,
              availableQuantity: listing.available_quantity || 0,
              total_quantity: listing.total_quantity || 0,
              ...
              <Table className="w-full">
                <TableHeader>
                  <TableRow className="bg-gradient-to-r from-slate-100 via-slate-50 to-slate-100 border-b-2 hover:bg-gradient-to-r hover:from-slate-100 hover:via-slate-50 hover:to-slate-100">
                    ...
                    <TableHead className="font-bold text-slate-800 w-[120px] text-center">Số lượng</TableHead>
                  ...
                  {currentListings.map((listing, index) => (
                    ...
                    >
                      ...
                      <TableCell className="py-3 text-center">
                        {((listing.totalQuantity || listing.total_quantity || 0) > 1) ? (
                          <div className="inline-flex flex-col items-center gap-1 px-3 py-2 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-300">
                            <div className="text-sm font-bold text-blue-700">
                              {listing.availableQuantity || listing.available_quantity || 0} / {listing.totalQuantity || listing.total_quantity}
                            </div>
