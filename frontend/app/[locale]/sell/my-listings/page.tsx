...
import { Package, Edit, Eye, Trash2, Archive, Plus, DollarSign, MapPin, Calendar, ChevronLeft, ChevronRight, Briefcase, Settings, Star } from 'lucide-react';
                    ...
                    {paginatedListings.map((listing: any) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 flex-wrap mb-4 pb-4 border-b border-primary/10">
                          ...
                          {/* ============ 🆕 SHOW QUANTITY - GIỐNG TRANG LISTINGS ============ */}
                          {((listing.total_quantity || listing.totalQuantity || 0) > 1) && (
                            <div className="px-3 py-2 rounded-md bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-300">
                              ...
                              <span className="text-blue-600 text-sm font-bold">
                                {listing.available_quantity ?? listing.availableQuantity ?? listing.total_quantity ?? listing.totalQuantity} container
                              </span>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                          ...
                          {/* 🆕 Manage Rental Button - Only show for RENTAL deal type */}
                          {listing.deal_type === 'RENTAL' && (
                            <Button 
                              size="sm" 
                              variant="outline"
                              asChild
                              className="flex-1 sm:flex-none hover:bg-purple-50 hover:border-purple-500 hover:text-purple-600 transition-all duration-300"
                            >
                              <Link href={`/sell/my-listings/${listing.id}/manage-rental`}>
