...
export function ConfirmReceiptForm({ isOpen, orderId, onSuccess, onClose }: ConfirmReceiptFormProps) {
          ...
          <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-2xl p-6 border border-green-100 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Chọn tình trạng container khi nhận <span className="text-red-500">*</span></p>
              </div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-green-100/50">
              ...
              <div className={`flex items-start space-x-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                ...
                <label htmlFor="good" className="flex-1 cursor-pointer">
                  ...
                  <p className="text-sm text-gray-600">
                    Container nguyên vẹn, không có dấu hiệu hư hỏng. Đơn hàng sẽ được hoàn tất.
                  </p>
                </label>
              </div>
              ...
              <div className={`flex items-start space-x-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                ...
                <label htmlFor="minor" className="flex-1 cursor-pointer">
                  ...
                  <p className="text-sm text-gray-600">
                    Có một số vấn đề nhỏ nhưng vẫn chấp nhận được. Đơn hàng vẫn hoàn tất.
                  </p>
                </label>
              </div>
              ...
              <div className={`flex items-start space-x-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                ...
                <label htmlFor="major" className="flex-1 cursor-pointer">
                  ...
                  <p className="text-sm text-gray-600">
                    Container bị hư hỏng nghiêm trọng hoặc không đúng mô tả. Tranh chấp sẽ được tạo.
                  </p>
                </label>
              </div>
            </RadioGroup>
          ...
          <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-100 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Mô tả chi tiết tình trạng hàng hóa</p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-red-100/50">
                    <p className="text-sm text-gray-700">
                      Khi chọn "Hư hỏng nghiêm trọng", một tranh chấp sẽ được tạo và đơn hàng sẽ 
                      chuyển sang trạng thái chờ admin xem xét. Thanh toán cho seller sẽ bị tạm giữ.
                    </p>
                  </div>
                </div>
              </div>
