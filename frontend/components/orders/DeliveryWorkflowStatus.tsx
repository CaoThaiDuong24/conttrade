                      ...
                      {isCurrent && (
                        <div className="mt-3 space-y-3">
                          ...
                          {currentStatus === 'documents_ready' && (
                            <div className="space-y-2">
                              <p className="text-sm text-gray-700 bg-purple-50 p-3 rounded-lg border border-purple-200 leading-relaxed">
                                📄 Chứng từ đã sẵn sàng. {userRole === 'buyer' ? 'Vui lòng đặt vận chuyển để tiếp tục.' : 'Đợi buyer đặt vận chuyển.'}
                              </p>
                              <div className="flex gap-2 flex-wrap">
                                {userRole === 'buyer' && (
                                  <Button size="sm" onClick={onBookTransportation} className="bg-blue-600 hover:bg-blue-700 shadow-md">
