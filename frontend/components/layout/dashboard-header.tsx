...
import { Search, User, LogOut, Settings, CreditCard, Plus, Star, FileText, Package, Building } from 'lucide-react';
      ...
      <div className="flex h-16 items-center gap-4 px-4 lg:px-6">
        ...
        <div className="flex items-center gap-1.5 ml-auto lg:ml-0">
          ...
          {userInfo?.roles && userInfo.roles.length > 0 && (() => {
            ...
            console.log('🔍 DashboardHeader Button Check:', { roles, isBuyer, isSeller, shouldShow: isBuyer && !isSeller });
            ...
            if (isBuyer && !isSeller) {
              return (
                <Button 
                  asChild 
                  size="sm"
                  className="hidden sm:flex items-center gap-2 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-md hover:shadow-lg transition-all"
                >
