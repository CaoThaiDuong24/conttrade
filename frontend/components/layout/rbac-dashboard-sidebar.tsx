...
const ALL_MENU_ITEMS = [
  ...
  // Seller - Rental Management (Quản lý cho thuê container)
  { 
    title: 'Quản lý cho thuê', 
    url: '/sell/rental-management/dashboard', 
    icon: 'Building2',
    requiredPermission: 'PM-110', // MANAGE_RENTAL_CONTAINERS (dedicated rental permission)
    order: 3.5,
    subItems: [
      { title: 'Tổng quan', url: '/sell/rental-management/dashboard', icon: 'BarChart3' },
      { title: 'Container', url: '/sell/rental-management/containers', icon: 'Package' },
      { title: 'Hợp đồng', url: '/sell/rental-management/contracts', icon: 'FileText' },
      { title: 'Bảo dưỡng', url: '/sell/rental-management/maintenance', icon: 'Wrench' },
  ...
  // Buyer - Container Rentals (Container đang thuê)
  { 
    title: 'Container đang thuê', 
    url: '/my-rentals/active', 
    icon: 'Container',
    requiredPermission: 'PM-130', // VIEW_MY_RENTALS (dedicated rental permission for buyer)
    order: 3.8,
    subItems: [
  ...
  { 
    ...
    subItems: [
      ...
      { title: 'Quản lý đánh giá', url: '/sell/my-reviews', icon: 'List' },
    ]
  },
